...
pub struct WebhookDataCreateResult {
    ...
    pub authorized_events: Option<models::WebhookDataBaseAuthorizedEvents>,
...
impl WebhookDataCreateResult {
    pub fn new() -> WebhookDataCreateResult {
