...
pub struct CrowdfundAppRequest {
    /// Id of the app
    ...
    #[serde(rename = "perksTemplate", skip_serializing_if = "Option::is_none")]
    pub perks_template: Option<String>,
}

impl CrowdfundAppRequest {
    pub fn new() -> CrowdfundAppRequest {
        CrowdfundAppRequest {
            id: None,
            app_name: None,
            store_id: None,
