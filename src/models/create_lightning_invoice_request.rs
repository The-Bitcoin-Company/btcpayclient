...
pub struct CreateLightningInvoiceRequest {
    ...
    #[serde(
        rename = "descriptionHashOnly",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub description_hash_only: Option<Option<bool>>,
    /// Expiration time in seconds
    #[serde(rename = "expiry", skip_serializing_if = "Option::is_none")]
    pub expiry: Option<models::TimeSpanSeconds>,
    /// True if the invoice should include private route hints
    #[serde(
        rename = "privateRouteHints",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub private_route_hints: Option<Option<bool>>,
}
