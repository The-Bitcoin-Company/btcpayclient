...
pub struct LightningNodeInformationData {
    ...
    pub peers_count: Option<Option<i32>>,
    /// The number of active channels
    #[serde(
        rename = "activeChannelsCount",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub active_channels_count: Option<Option<i32>>,
    /// The number of inactive channels
    #[serde(
        rename = "inactiveChannelsCount",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub inactive_channels_count: Option<Option<i32>>,
    /// The number of pending channels
    #[serde(
        rename = "pendingChannelsCount",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub pending_channels_count: Option<Option<i32>>,
}
...
impl LightningNodeInformationData {
    pub fn new() -> LightningNodeInformationData {
        LightningNodeInformationData {
            ...
            version: None,
            peers_count: None,
            active_channels_count: None,
            inactive_channels_count: None,
            pending_channels_count: None,
        }
    }
}
