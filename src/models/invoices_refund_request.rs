...
pub struct InvoicesRefundRequest {
    ...
    #[serde(rename = "refundVariant", skip_serializing_if = "Option::is_none")]
    pub refund_variant: Option<RefundVariant>,
    /// Optional percentage by which to reduce the refund, e.g. as processing charge or to compensate for the mining fee.
    #[serde(rename = "subtractPercentage", skip_serializing_if = "Option::is_none")]
    pub subtract_percentage: Option<String>,
    /// The amount to refund if the `refundVariant` is `Custom`.
    #[serde(rename = "customAmount", skip_serializing_if = "Option::is_none")]
    pub custom_amount: Option<String>,
    /// The currency to refund if the `refundVariant` is `Custom`
    #[serde(rename = "customCurrency", skip_serializing_if = "Option::is_none")]
    pub custom_currency: Option<String>,
}

impl InvoicesRefundRequest {
    pub fn new() -> InvoicesRefundRequest {
        InvoicesRefundRequest {
            name: None,
            description: None,
            payout_method_id: None,
            refund_variant: None,
            subtract_percentage: None,
            custom_amount: None,
...
pub enum RefundVariant {
    ...
    OverpaidAmount,
    #[serde(rename = "RateThen")]
    RateThen,
}

impl Default for RefundVariant {
    fn default() -> RefundVariant {
        Self::CurrentRate
    }
}
