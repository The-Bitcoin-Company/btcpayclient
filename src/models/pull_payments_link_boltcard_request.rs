...
pub struct PullPaymentsLinkBoltcardRequest {
    ...
    #[serde(rename = "onExisting", skip_serializing_if = "Option::is_none")]
    pub on_existing: Option<OnExisting>,
}

impl PullPaymentsLinkBoltcardRequest {
    pub fn new(uid: String) -> PullPaymentsLinkBoltcardRequest {
