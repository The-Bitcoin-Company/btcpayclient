...
pub struct InvoiceData {
    ...
    pub metadata: Option<models::InvoiceMetadata>,
    ...
    pub checkout: Option<Option<models::CheckoutOptions>>,
    ...
    pub monitoring_expiration: Option<f64>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::InvoiceStatus>,
    #[serde(rename = "additionalStatus", skip_serializing_if = "Option::is_none")]
    pub additional_status: Option<models::InvoiceAdditionalStatus>,
    /// The statuses the invoice can be manually marked as
    #[serde(
        rename = "availableStatusesForManualMarking",
        skip_serializing_if = "Option::is_none"
    )]
    pub available_statuses_for_manual_marking: Option<Vec<models::InvoiceStatus>>,
