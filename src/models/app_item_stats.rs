...
pub struct AppItemStats {
    ...
    #[serde(rename = "salesCount", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "totalFormatted", skip_serializing_if = "Option::is_none")]
    pub total_formatted: Option<String>,
}

impl AppItemStats {
    pub fn new() -> AppItemStats {
        AppItemStats {
            item_code: None,
            title: None,
            sales_count: None,
