...
pub struct PaymentRequestsPayRequest {
    ...
    #[serde(
        rename = "allowPendingInvoiceReuse",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub allow_pending_invoice_reuse: Option<Option<bool>>,
}

impl PaymentRequestsPayRequest {
    pub fn new() -> PaymentRequestsPayRequest {
        PaymentRequestsPayRequest {
            amount: None,
            allow_pending_invoice_reuse: None,
        }
    }
}
