...
pub async fn payout_processors_get_payout_processors(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::PayoutProcessorData>, Error<PayoutProcessorsGetPayoutProcessorsError>> {
    let uri_str = format!("{}/api/v1/payout-processors", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PayoutProcessorsGetPayoutProcessorsError> =
